...
**1.** **QR DATA** Through news channels and social medias, we were able to find a sample COVID pass as below:
...
![](images/1.jpg) Source: [https://thanhtra.com.vn/xa-hoi/doi-song/ghi-nhan-trong-ngay-dau-ha-noi-thuc-hien-gian-cach-xa-hoi-phan-vung-187326.html](https://thanhtra.com.vn/xa-hoi/doi-song/ghi-nhan-trong-ngay-dau-ha-noi-thuc-hien-gian-cach-xa-hoi-phan-vung-187326.html)
...
It was not hard for us to find out the application on Google Play Store (now removed). However, due to countries restriction, we had to use VPN to download the application named “**Kiểm soát đi đường**” a.k.a "**Vehicle Operating Control**" (Translated as best as I can)
...
**3.** **DEEPER DIVE INTO THE WORKFLOW** The original data was retrieved from the QR:
...
![](images/6.jpg) Setting up EC2 instances
