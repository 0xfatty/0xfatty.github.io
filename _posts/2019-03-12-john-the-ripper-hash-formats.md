...
[John the Ripper](http://www.openwall.com/john/) is a favourite password cracking tool of many pentesters.  There is plenty of [documentation](http://www.openwall.com/john/doc/EXAMPLES.shtml) about its command line options.
...
This sheet was originally based on [john-1.7.8-jumbo-5](http://www.openwall.com/john/g/john-1.7.8-jumbo-5.tar.gz).  Changes in supported hashes or hash formats since then may not be reflected on this page.
...
$ cat hashes.txt
5d2e19393cc5ef67
$ john hashes.txt # Doesn't work.  JTR detects hash as "MYSQL\_fast".
...
TODO: No working example yet. TODO: No working example yet. TODO: No working example yet. TODO: No working example yet.
